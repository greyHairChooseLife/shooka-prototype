    ...
    return (
        <div className="mx-auto max-w-2xl space-y-12 px-4 py-12">
            ...
            <section className="space-y-4">
                <h2 className="text-lg font-semibold text-gray-100">왜 만들었나</h2>
            ...
            {/* 댓글 분류 카테고리 */}
            <section className="space-y-4">
                <h2 className="text-lg font-semibold text-gray-100">댓글 분류 카테고리</h2>
                ...
                <Collapsible title="분석 파이프라인">
                    <div className="space-y-5">
                        <p className="text-sm text-gray-500">
                            ...
                            각 단계는 SSE(Server-Sent Events)로 실시간 진행 상황이 화면에 표시됩니다.
                        </p>
                        <div className="space-y-5">
                            ...
                            <Step n={5} title="집계">
                                ...
                                공감을 많이 받은 댓글이 시청자 반응을 더 대표한다는 전제 하에,
                                단순 댓글 수 대신 가중 점수로 비중을 산정합니다.
                            </Step>
                ...
                <Collapsible title="기술 스택">
                    <div className="space-y-3">
                        {[
                            {
                                label: '프레임워크',
                                tags: ['Next.js 15 (App Router)', 'TypeScript', 'Tailwind CSS'],
                            },
                            {
                                label: '데이터',
                                tags: ['YouTube Data API v3', 'youtube-transcript', 'SQLite (better-sqlite3)'],
                            },
                            {
                                label: 'LLM',
                                tags: ['Claude (Anthropic)', 'GPT-4o (OpenAI)', 'Gemini (Google)'],
                            },
                            {
                                label: '스트리밍',
                                tags: ['Server-Sent Events (SSE)', 'ReadableStream'],
                            },
                            {
                                label: '시각화',
                                tags: ['Recharts'],
